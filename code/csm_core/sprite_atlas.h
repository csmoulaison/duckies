#ifndef csm_sprite_atlas_h_INCLUDED
#define csm_sprite_atlas_h_INCLUDED

#ifndef CSM_MODULE_TEXTURE
#error CSM_MODULE_SPRITE_ATLAS requires CSM_MODULE_TEXTURE
#endif

#ifndef CSM_MODULE_ASSET_BUILDER
#error CSM_MODULE_SPRITE_ATLAS requires CSM_MODULE_ASSET_BUILDER
#endif

#ifndef CSM_MODULE_SPRITE
#error CSM_MODULE_SPRITE_ATLAS requires CSM_MODULE_SPRITE
#endif
...
void sprite_atlas_builder_init(SpriteAtlasBuilder* builder, TextureFormat format, Stack* stack);
...
void sprite_atlas_build_assets(SpriteAtlasBuilder* builder, AssetBuilder* pack_builder, Stack* stack) {
	...
	u32 pack_order[builder->sprites_len];
